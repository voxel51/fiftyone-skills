...
| 🦁 [**Zoo Remote Model**](skills/fiftyone-zoo-remote-model/SKILL.md) | Build remote model zoo integrations with `register_zoo_model_source`, DataLoader, and `dataset.apply_model` | — |
